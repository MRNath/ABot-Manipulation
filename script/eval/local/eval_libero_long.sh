#!/bin/bash
# =============================================================================
# Local multi-GPU LIBERO-Long (libero_10) eval script
#
# Usage:
#   bash script/eval/local/eval_libero_long.sh
#   POSTTRAIN_CKPT=/path/to/ckpt bash script/eval/local/eval_libero_long.sh
# =============================================================================
...
# ======================== Model config ========================
CONFIG_NAME=${CONFIG_NAME:-libero_10}
...
# ======================== Run ========================
echo "============================================"
echo "[eval_libero_long] local eval config:"
