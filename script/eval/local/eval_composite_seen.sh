...
HORIZON_JSON=${HORIZON_JSON:-${_SCRIPT_DIR}/target_composite_seen_task_horizons.json}
SEED=${SEED:-0}
...
RUN_ROOT_BASE=${RUN_ROOT_BASE:-outputs/robocasa_eval_env_sweep_local_dynamic_mot_pretrain_composite_seen}
if [ -n "${CKPT_PATH}" ]; then
...
echo "=========================================="
echo "Local RoboCasa Dynamic Eval (COMPOSITE SEEN, MoT, PRETRAIN split)"
echo "=========================================="
