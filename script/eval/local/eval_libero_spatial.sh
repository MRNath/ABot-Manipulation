#!/usr/bin/env bash
# =============================================================================
# Local multi-GPU LIBERO-Spatial eval script
#
# Usage:
#   bash script/eval/local/eval_libero_spatial.sh
#   POSTTRAIN_CKPT=/path/to/ckpt bash script/eval/local/eval_libero_spatial.sh
# =============================================================================
...
# ======================== Eval target ========================
BENCHMARK=${BENCHMARK:-libero_spatial}
SEED=${SEED:-2222}
...
# ======================== Run ========================
echo "============================================"
echo "[eval_libero_spatial] local eval config:"
