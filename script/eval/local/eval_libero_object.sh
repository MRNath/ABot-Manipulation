#!/bin/bash
# =============================================================================
# Local multi-GPU LIBERO-Object eval script
#
# Usage:
#   bash script/eval/local/eval_libero_object.sh
#   POSTTRAIN_CKPT=/path/to/ckpt bash script/eval/local/eval_libero_object.sh
# =============================================================================
...
# ======================== Run ========================
echo "============================================"
echo "[eval_libero_object] local eval config:"
