#!/bin/bash
# =============================================================================
# Local multi-GPU LIBERO eval script (runs directly on the local machine, no cluster submission)
#
# Calls evaluation/libero/launch_eval_my_ckpt.sh to run multi-GPU parallel eval locally.
#
# Usage:
#   bash script/eval/local/eval_libero_local.sh
#
#   # specify checkpoint
#   POSTTRAIN_CKPT=/path/to/ckpt bash script/eval/local/eval_libero_local.sh
#
#   # switch benchmark
#   BENCHMARK=libero_spatial bash script/eval/local/eval_libero_local.sh
# =============================================================================
...
# ======================== Run ========================
echo "============================================"
echo "[eval_libero_local] local eval config:"
echo "  BENCHMARK            = $BENCHMARK"
echo "  SEED                 = $SEED"
echo "  CONFIG_NAME          = $CONFIG_NAME"
echo "  CUDA_VISIBLE_DEVICES = $CUDA_VISIBLE_DEVICES"
echo "  PY_BIN_SERVER        = $PY_BIN_SERVER"
echo "  PY_BIN_CLIENT        = $PY_BIN_CLIENT"
echo "  WAN22_PRETRAINED_PATH= $WAN22_PRETRAINED_PATH"
